...
class Lidar
{
    ...
    public:
        ...
        //Lidar(const typename pcl::PointCloud<PointT>::Ptr &inputCloud) : pointCloud(new pcl::PointCloud<PointT>(inputCloud))
        //{}

        //*****************************************************************************//
        //  Applying Rule of 5 to define the Copy/Move/Copy/Move Assignment/ Destructor//
        // Methods  
        ...
        {
            std::cout << "Assigning content from the : " << *lidarObject << " to " << *this << std::endl;
            if(this == &lidarObject)
            {
                return *this;
            }
